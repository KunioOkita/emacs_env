...
;; set the keybind
(global-set-key (kbd "C-x M-f") 'finder-current-dir-open)
...
(when (require 'auto-complete-config nil t)
  ...
  (defvar ac-dwim t)
  (defvar ac-use-menu-map t) ;; C-n/C-pで候補選択可能
  ...
  (defvar ac-comphist-file "~/.emacs.d/elisp/auto-complete/ac-comphist.dat") ;; 補完履歴のキャッシュ先
  )
...
(add-hook 'js2-mode-hook
          (lambda ()
            ...
            (defvar js2-indent-level 2)
            (defvar js2-switch-indent-offset 2)
...
;;-----------------------------------------------------------
;; google search
(defvar eww-search-prefix "https://www.google.co.jp/search?q=")
...
(defvar plantuml-jar-path "/usr/local/Cellar/plantuml/1.2019.10/libexec/plantuml.jar")
